...
raw_path = '/raid/workspace/andreim/nemovrive/sessions/'
days = os.listdir(raw_path)
dataset_path = '/raid/workspace/andreim/nemovrive/upb_data/dataset/train_frames/'
			...
			for f in files:
				if 'center_full.mov' in f or '-0'in f:
					...
					with open(json_file, 'r') as jf:
						...
						camera_matrix[0, :] /= 3.0
						camera_matrix[1, :] /= 3.0
						cam[f.replace('.mov', '')] = camera_matrix
