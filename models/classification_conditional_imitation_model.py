...
def get_models():
    return [ClassificationConditionalImitationModel]


class ClassificationConditionalImitationModel(nn.Module):
    def __init__(self, cfg, in_size, out_size):
        super(ClassificationConditionalImitationModel, self).__init__()
