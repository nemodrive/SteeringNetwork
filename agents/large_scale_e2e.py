...
def to_variable(data, use_cuda):
    ...
    if use_cuda:
        input_, target_ = input_.cuda(), target_.git ()

    return input_, target_


class LargeScaleE2EAgent(LearningAgent):
    def __init__(self, cfg):
        super(LargeScaleE2EAgent, self).__init__(cfg)
        ...
        super(LargeScaleE2EAgent, self).__end_init__()
